$(function(){
    ...
    // $(".ge-mart-slide .slide-wrap li").on('click', function(){
    //     nav_w=$(this).width();
    //     // $(".sideline").stop(true);
    ...
    var fl_w=$('.ge-mart-slide .slide-wrap').width();

    var flb_w=$('.ge-mart-slide').width();
    console.log(fl_w,flb_w);
    var x1,y1,ty_left,x2,y2;
    $('.ge-mart-slide .slide-wrap').on('touchstart', function (e) {
        var touch1 = e.originalEvent.targetTouches[0];
        x1 = touch1.pageX;
        y1 = touch1.pageY;
        ty_left = parseInt($(this).css('left'));
    });
    $('.ge-mart-slide .slide-wrap').on('touchmove', function (e) {
